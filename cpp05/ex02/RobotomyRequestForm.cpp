...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/10/20 12:19:57 by sangyeki          #+#    #+#             */
/*   Updated: 2022/10/20 12:20:12 by sangyeki         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
RobotomyRequestForm::RobotomyRequestForm(std::string target) : Form("RobotomyRequestForm", 72, 45), _target(target) // 사인등급 72, 실행등급 45
{
